...
public class SlideSwitch extends View {
    ...
    private static final int COLOR_THEME = Color.parseColor("#fed724");
    // 3 attributes
    ...
    public SlideSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        color_theme = a.getColor(R.styleable.slide_switch_themeColor,
                COLOR_THEME);
        isOpen = a.getBoolean(R.styleable.slide_switch_isOpen, false);
        shape = a.getInt(R.styleable.slide_switch_shape, SHAPE_RECT);
        a.recycle();
    }
